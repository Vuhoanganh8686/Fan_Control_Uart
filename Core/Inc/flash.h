...
#define ADDR_FLASH_PAGE_0    ((uint32_t)0x08000000) /* Base @ of Sector 0, 2 Kbytes */
#define ADDR_FLASH_PAGE_1    ((uint32_t)0x08004000) /* Base @ of Sector 1, 2 Kbytes */
#define ADDR_FLASH_PAGE_2    ((uint32_t)0x08008000) /* Base @ of Sector 2, 2 Kbytes */
